...
- Install the packages needed for your selected toppings, (re)installing `oxlint`, `oxfmt`, and `@chanom/dev-config` if missing or not at the expected pinned version
